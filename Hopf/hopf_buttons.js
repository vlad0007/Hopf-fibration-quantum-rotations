...
function Lbl_2 (name, left, top )
{
	...
	this.id.style = "position: absolute";
	this.id.style.background='#ffccff';
...
{	
	...
	////////////////////////////////////////////////////////
	const lbl_thick_circle = new Lbl_2("Thick lines ", "1050px", "425px" );
	
	const lbl_axes = new Lbl_2("Axes ", "1210px", "422px" );
	lbl_axes.id.style.width = "50px";
	lbl_axes.id.style.background='#ffccff';	
	lbl_axes.id.style.color='#000000';

	const lbl_spiral = new Lbl_3("Rotate spiral Z", "1180px", "472px" );
	lbl_axes.id.style.width = "50px";
	lbl_axes.id.style.background='#ffccff';	
	lbl_axes.id.style.color='#000000';
}
